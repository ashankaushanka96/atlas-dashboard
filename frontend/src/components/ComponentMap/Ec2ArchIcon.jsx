// src/components/ComponentMap/Ec2ArchIcon.jsx
// Official AWS Architecture icon for Amazon EC2, supplied by the user
// (Icon-Architecture/64/Arch_Amazon-EC2_64). Rendered as-is, including its
// own compute-orange background tile -- do not re-badge it elsewhere.
import React from "react";
import PropTypes from "prop-types";

const Ec2ArchIcon = ({ size = 44 }) => (
  <svg width={size} height={size} viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient x1="0%" y1="100%" x2="100%" y2="0%" id="ec2-arch-gradient">
        <stop stopColor="#C8511B" offset="0%" />
        <stop stopColor="#FF9900" offset="100%" />
      </linearGradient>
    </defs>
    <g fill="none" fillRule="evenodd">
      <g fill="url(#ec2-arch-gradient)">
...
Ec2ArchIcon.propTypes = {
  size: PropTypes.number,
};

export default Ec2ArchIcon;
